...
Airbnb raster within neighbourhood
...
Comparison within Downtown Core
...
Overall, we can conclude that airbnb in the four areas are not randomly distributed. For further analysis, we will narrow down to two areas, River valley and Rochor because they have R above 0.8, which is near 1. When R is nearer to 1, the distribution are likely random. Hence, we are interested to further analyse the distribution of airbnb within these two region.
