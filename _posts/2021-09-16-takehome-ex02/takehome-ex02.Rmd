...
Analysis: The plot above reveals that there is a sign that the marked spatial point events are not independent spatially from distance 0 to 140m as the L(r) is above 0. From 140m and above, there is a sign that the marked spatial point events are independent spatially as the L(r) is below 0. Hypothesis test is required to confirm the observation statistically.
...
Analysis: The plot above reveals that there is a sign that the marked spatial point events are not independent spatially from distance 10 to 200m as the L(r) is above 0. From 0 to 10m, and 200 meter and above, there is a sign that the marked spatial point events are independent spatially as the L(r) is below 0. Hypothesis test is required to confirm the observation statistically.
...
Analysis: The plot above reveals that there is a sign that the marked spatial point events are not independent spatially from distance 10m and above as the L(r) is above 0. From 0 - 10m, there is a sign that the marked spatial point events are independent spatially as the L(r) is below 0. Hypothesis test is required to confirm the observation statistically.
...
Analysis: The plot above shows that the observed L(r) line is above L(theo) from about 10m onwards and is within the higher confidence envelope which means spatial clustering for that distance is statistically not significant. Hence, we do not reject the null hypothesis that the distribution of Shared Room Airbnb and Entire home/apt Airbnb in 2021 are spatially independent at 99.9% confident interval.
